...
GLM_FUNC_QUALIFIER T simplex(const vec<3, T, Q>& v)
{
    ...
    // Permutations
    i = detail::mod289(i);
    vec<4, T, Q> p(detail::permute(detail::permute(detail::permute(i.z + vec<4, T, Q>(T(0), i1.z, i2.z, T(1))) + i.y +
                                                   vec<4, T, Q>(T(0), i1.y, i2.y, T(1))) +
...
GLM_FUNC_QUALIFIER T simplex(const vec<4, T, Q>& v)
{
    ...
    vec<4, T, Q> j1 = detail::permute(
        detail::permute(detail::permute(detail::permute(i.w + vec<4, T, Q>(i1.w, i2.w, i3.w, T(1))) + i.z +
                                        vec<4, T, Q>(i1.z, i2.z, i3.z, T(1))) +
