...
GLM_FUNC_DECL qua<T, Q> mix(const qua<T, Q>& x, const qua<T, Q>& y, T a);
...
/// @tparam Q A value from qualifier enum
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR qua<T, Q> lerp(const qua<T, Q>& x, const qua<T, Q>& y, T a);
...
/// @tparam Q A value from qualifier enum
template <typename T, qualifier Q>
GLM_FUNC_DECL qua<T, Q> slerp(const qua<T, Q>& x, const qua<T, Q>& y, T a);
...
GLM_FUNC_DECL qua<T, Q> slerp(const qua<T, Q>& x, const qua<T, Q>& y, T a, S k);
...
/// @tparam Q A value from qualifier enum
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR qua<T, Q> conjugate(const qua<T, Q>& q);
...
/// @tparam Q A value from qualifier enum
template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR qua<T, Q> inverse(const qua<T, Q>& q);
...
/// @tparam Q A value from qualifier enum
template <typename T, qualifier Q>
GLM_FUNC_DECL vec<4, bool, Q> isnan(const qua<T, Q>& x);
...
/// @tparam Q A value from qualifier enum
template <typename T, qualifier Q>
GLM_FUNC_DECL vec<4, bool, Q> isinf(const qua<T, Q>& x);
