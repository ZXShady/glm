...
/// @tparam Q Value from qualifier enum
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, bool, Q> equal(const vec<L, T, Q>& x, const vec<L, T, Q>& y, const vec<L, T, Q>& epsilon);
...
/// @tparam Q Value from qualifier enum
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, bool, Q> notEqual(const vec<L, T, Q>& x, const vec<L, T, Q>& y, const vec<L, T, Q>& epsilon);
...
/// @tparam Q Value from qualifier enum
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, bool, Q> equal(const vec<L, T, Q>& x, const vec<L, T, Q>& y, const vec<L, int, Q>& ULPs);
...
/// @tparam Q Value from qualifier enum
template <length_t L, typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR vec<L, bool, Q> notEqual(const vec<L, T, Q>& x, const vec<L, T, Q>& y, const vec<L, int, Q>& ULPs);
