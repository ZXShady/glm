...
GLM_FUNC_DECL GLM_CONSTEXPR bool equal(const genType& x, const genType& y, const genType& epsilon);
...
/// @tparam genType Floating-point or integer scalar types
template <typename genType>
GLM_FUNC_DECL GLM_CONSTEXPR bool notEqual(const genType& x, const genType& y, const genType& epsilon);
...
/// @tparam genType Floating-point or integer scalar types
template <typename genType>
GLM_FUNC_DECL GLM_CONSTEXPR bool equal(const genType& x, const genType& y, int ULPs);
...
/// @tparam genType Floating-point or integer scalar types
template <typename genType>
GLM_FUNC_DECL GLM_CONSTEXPR bool notEqual(const genType& x, const genType& y, int ULPs);
