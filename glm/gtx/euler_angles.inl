...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleX(T const& angleX)
{
    ...
    return mat<4, 4, T, defaultp>(T(1), T(0), T(0), T(0), T(0), cosX, sinX, T(0), T(0), -sinX, cosX, T(0), T(0), T(0), T(0), T(1));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleY(T const& angleY)
{
    ...
    return mat<4, 4, T, defaultp>(cosY, T(0), -sinY, T(0), T(0), T(1), T(0), T(0), sinY, T(0), cosY, T(0), T(0), T(0), T(0), T(1));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> eulerAngleZ(T const& angleZ)
{
    ...
    return mat<4, 4, T, defaultp>(cosZ, sinZ, T(0), T(0), -sinZ, cosZ, T(0), T(0), T(0), T(0), T(1), T(0), T(0), T(0), T(0), T(1));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> derivedEulerAngleX(T const& angleX, T const& angularVelocityX)
{
    ...
    return mat<4, 4, T, defaultp>(T(0), T(0), T(0), T(0), T(0), -sinX, cosX, T(0), T(0), -cosX, -sinX, T(0), T(0), T(0), T(0), T(0));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> derivedEulerAngleY(T const& angleY, T const& angularVelocityY)
{
    ...
    return mat<4, 4, T, defaultp>(-sinY, T(0), -cosY, T(0), T(0), T(0), T(0), T(0), cosY, T(0), -sinY, T(0), T(0), T(0), T(0), T(0));
}
...
GLM_FUNC_QUALIFIER mat<4, 4, T, defaultp> derivedEulerAngleZ(T const& angleZ, T const& angularVelocityZ)
{
    ...
    return mat<4, 4, T, defaultp>(-sinZ, cosZ, T(0), T(0), -cosZ, -sinZ, T(0), T(0), T(0), T(0), T(0), T(0), T(0), T(0), T(0), T(0));
}
