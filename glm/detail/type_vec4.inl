...
template <typename T, qualifier Q>
GLM_DEFAULTED_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, T, Q>::vec(vec<4, T, Q> const& v) : x(v.x), y(v.y), z(v.z), w(v.w)
{
}
#endif
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, T, Q>::vec(vec<4, T, P> const& v) : x(v.x), y(v.y), z(v.z), w(v.w)
{
}
...
template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, float, aligned_highp>::vec(vec<4, float, aligned_highp> const& v) : data(v.data)
{
}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, float, aligned_highp>::vec(vec<4, float, packed_highp> const& v)
{
    data = _mm_loadu_ps(reinterpret_cast<float const*>(&v));
}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, float, packed_highp>::vec(vec<4, float, aligned_highp> const& v)
{
...
template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, int, aligned_highp>::vec(vec<4, int, aligned_highp> const& v) : data(v.data)
{
}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, int, aligned_highp>::vec(vec<4, int, packed_highp> const& v)
{
    data = _mm_loadu_si128(reinterpret_cast<__m128i const*>(&v));
}

template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, int, packed_highp>::vec(vec<4, int, aligned_highp> const& v)
{
...
template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, double, aligned_highp>::vec(vec<4, double, aligned_highp> const& v)
{
...
template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, double, aligned_highp>::vec(vec<4, double, packed_highp> const& v)
{
#if (GLM_ARCH & GLM_ARCH_AVX_BIT)
    data = _mm256_loadu_pd(reinterpret_cast<double const*>(&v));
#else
...
template <>
template <>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<4, double, packed_highp>::vec(vec<4, double, aligned_highp> const& v)
{
#if (GLM_ARCH & GLM_ARCH_AVX_BIT)
