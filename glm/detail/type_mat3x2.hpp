...
public:
    ...
    GLM_CTOR_DECL mat(const mat<3, 2, T, P>& m);
    ...
    GLM_CTOR_DECL mat(const vec<2, V1, Q>& v1, const vec<2, V2, Q>& v2, const vec<2, V3, Q>& v3);

    // -- Matrix conversions --

    template <typename U, qualifier P>
    GLM_CTOR_DECL GLM_EXPLICIT mat(const mat<3, 2, U, P>& m);
    ...
    template <typename U>
    GLM_FUNC_DISCARD_DECL GLM_CONSTEXPR mat& operator=(const mat<3, 2, U, Q>& m);
};

// -- Unary operators --

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<3, 2, T, Q>::col_type operator*(const mat<3, 2, T, Q>&                    m,
                                                                         const typename mat<3, 2, T, Q>::row_type& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<3, 2, T, Q>::row_type operator*(const typename mat<3, 2, T, Q>::col_type& v,
                                                                         const mat<3, 2, T, Q>&                    m);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 2, T, Q> operator*(const mat<3, 2, T, Q>& m1, const mat<2, 3, T, Q>& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 2, T, Q> operator*(const mat<3, 2, T, Q>& m1, const mat<3, 3, T, Q>& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 2, T, Q> operator*(const mat<3, 2, T, Q>& m1, const mat<4, 3, T, Q>& m2);
} //namespace glm
