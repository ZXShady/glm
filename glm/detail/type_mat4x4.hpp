...
public:
    ...
    GLM_CTOR_DECL mat(const mat<4, 4, T, P>& m);
    ...
    GLM_CTOR_DECL mat(const vec<4, V1, Q>& v1, const vec<4, V2, Q>& v2, const vec<4, V3, Q>& v3, const vec<4, V4, Q>& v4);

    // -- Matrix conversions --

    template <typename U, qualifier P>
    GLM_CTOR_DECL GLM_EXPLICIT mat(const mat<4, 4, U, P>& m);
    ...
    template <typename U>
    GLM_FUNC_DISCARD_DECL GLM_CONSTEXPR mat& operator=(const mat<4, 4, U, Q>& m);
    template <typename U>
    GLM_FUNC_DISCARD_DECL GLM_CONSTEXPR mat<4, 4, T, Q>& operator*=(const mat<4, 4, U, Q>& m);
    template <typename U>
    GLM_FUNC_DISCARD_DECL GLM_CONSTEXPR mat<4, 4, T, Q>& operator/=(const mat<4, 4, U, Q>& m);
};

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<4, 4, T, Q>::col_type operator*(const mat<4, 4, T, Q>&                    m,
                                                                         const typename mat<4, 4, T, Q>::row_type& v);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR typename mat<4, 4, T, Q>::row_type operator*(const typename mat<4, 4, T, Q>::col_type& v,
                                                                         const mat<4, 4, T, Q>&                    m);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<2, 4, T, Q> operator*(const mat<4, 4, T, Q>& m1, const mat<2, 4, T, Q>& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<3, 4, T, Q> operator*(const mat<4, 4, T, Q>& m1, const mat<3, 4, T, Q>& m2);

template <typename T, qualifier Q>
GLM_FUNC_DECL GLM_CONSTEXPR mat<4, 4, T, Q> operator*(const mat<4, 4, T, Q>& m1, const mat<4, 4, T, Q>& m2);
