...
struct compute_vec_mul<L, int, Q, true>
{
    GLM_FUNC_QUALIFIER static vec<L, int, Q> call(const vec<L, int, Q>& a, const vec<L, int, Q>& b)
    {
        ...
        Result.data  = _mm_unpacklo_epi32(_mm_shuffle_epi32(tmp1, _MM_SHUFFLE(0, 0, 2, 0)),
...
#define CTOR_FLOAT(L, Q)                                                                     \
    template <>                                                                              \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q>::vec(float _s) : data(_mm_set1_ps(_s)) \
    {                                                                                        \
    }
...
#define CTOR_DOUBLE(L, Q)                                                                         \
    template <>                                                                                   \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, double, Q>::vec(double _s) : data(_mm256_set1_pd(_s)) \
    {                                                                                             \
    }
...
#define CTOR_INT64(L, Q)                                                                                            \
    template <>                                                                                                     \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, detail::int64, Q>::vec(detail::int64 _s) : data(_mm256_set1_epi64x(_s)) \
    {                                                                                                               \
    }
...
#define CTOR_INT(L, Q)                                                                      \
    template <>                                                                             \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, int, Q>::vec(int _s) : data(_mm_set1_epi32(_s)) \
    {                                                                                       \
    }
...
#define CTOR_INT3(L, Q)                                                                                                \
    template <>                                                                                                        \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, int, Q>::vec(int _x, int _y, int _z) : data(_mm_set_epi32(_z, _z, _y, _x)) \
    {                                                                                                                  \
    }
...
#define CTOR_DEFAULT(L, Q)                                                            \
    template <>                                                                       \
    template <>                                                                       \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q>::vec() : data(_mm_setzero_ps()) \
    {                                                                                 \
    }
...
#define CTOR_FLOAT(L, Q)                                                                     \
    template <>                                                                              \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q>::vec(float _s) : data(vdupq_n_f32(_s)) \
    {                                                                                        \
    }

#define CTOR_INT(L, Q)                                                                   \
    template <>                                                                          \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, int, Q>::vec(int _s) : data(vdupq_n_s32(_s)) \
    {                                                                                    \
    }

#define CTOR_UINT(L, Q)                                                                    \
    template <>                                                                            \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, uint, Q>::vec(uint _s) : data(vdupq_n_u32(_s)) \
    {                                                                                      \
    }
...
#define CTOR_VECF_VECF(L, Q)                                                                             \
    template <>                                                                                          \
    template <>                                                                                          \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q>::vec(const vec<L, float, Q>& rhs) : data(rhs.data) \
    {                                                                                                    \
    }
...
#define CTOR_VECF_VECI(L, Q)                                                                                          \
    template <>                                                                                                       \
    template <>                                                                                                       \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q>::vec(const vec<L, int, Q>& rhs) : data(vcvtq_f32_s32(rhs.data)) \
    {                                                                                                                 \
    }
...
#define CTOR_VECF_VECU(L, Q)                                                                                           \
    template <>                                                                                                        \
    template <>                                                                                                        \
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<L, float, Q>::vec(const vec<L, uint, Q>& rhs) : data(vcvtq_f32_u32(rhs.data)) \
    {                                                                                                                  \
    }
