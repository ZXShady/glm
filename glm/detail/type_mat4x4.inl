...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
    mat<4, 4, T, Q>::mat(const col_type& v0, const col_type& v1, const col_type& v2, const col_type& v3)
#if GLM_HAS_INITIALIZER_LISTS
:
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR
    mat<4, 4, T, Q>::mat(const vec<4, V1, Q>& v1, const vec<4, V2, Q>& v2, const vec<4, V3, Q>& v3, const vec<4, V4, Q>& v4)
#if GLM_HAS_INITIALIZER_LISTS
:
...
template <typename T, qualifier Q>
template <typename U>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T, Q>& mat<4, 4, T, Q>::operator=(const mat<4, 4, U, Q>& m)
{
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 4, T, Q>::col_type operator*(const mat<4, 4, T, Q>& m,
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 4, T, Q>::row_type operator*(const typename mat<4, 4, T, Q>::col_type& v,
                                                                              const mat<4, 4, T, Q>& m)
{
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<2, 4, T, Q> operator*(const mat<4, 4, T, Q>& m1, const mat<2, 4, T, Q>& m2)
{
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<3, 4, T, Q> operator*(const mat<4, 4, T, Q>& m1, const mat<3, 4, T, Q>& m2)
{
...
{
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR static mat<4, 4, T, Q> call(const mat<4, 4, T, Q>& m1, const mat<4, 4, T, Q>& m2)
    {
        ...
        const typename mat<4, 4, T, Q>::col_type
            tmp0 = glm::fma(SrcA3,
                            splatW(SrcB0),
...
template <typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T, Q> operator*(const mat<4, 4, T, Q>& m1, const mat<4, 4, T, Q>& m2)
{
